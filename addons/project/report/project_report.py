...
class report_project_task_user(osv.osv):
    ...
    _description = "Line Items by user and project"
    _auto = False
    _columns = {
        'name': fields.char('SITE ID', readonly=True),
        ...
        'nbr': fields.integer('# of Line Items', readonly=True),  # TDE FIXME master: rename into nbr_tasks
